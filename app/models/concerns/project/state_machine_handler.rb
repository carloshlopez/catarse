module Project::StateMachineHandler
  ...
  included do
    ...
    state_machine :state, initial: :draft do
      ...
      state :partially_funded, value: 'partially_funded'
      ...
      event :finish do
        ...
        transition waiting_funds: :partially_funded,      if: ->(project) {
          !project.should_fail? && !project.in_time_to_wait? && project.reached_something? && !   project.reached_goal? 
        }
        ...
        transition waiting_funds: :failed,      if: ->(project) {
          !project.should_fail? && !project.in_time_to_wait? && !project.reached_something?
        }
      ...
      after_transition any => [:failed, :successful, :partially_funded] do |project, transition|
